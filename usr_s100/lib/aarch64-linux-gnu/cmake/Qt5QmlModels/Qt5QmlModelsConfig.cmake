...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5QmlModels" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QmlModels_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5QmlModels_VERSION_STRING 5.15.3)
...
macro(_populate_QmlModels_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QmlModels_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(_Qt5QmlModels_OWN_INCLUDE_DIRS "${_qt5QmlModels_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5QmlModels_install_prefix}/include/aarch64-linux-gnu/qt5/QtQmlModels")
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/include/aarch64-linux-gnu/qt5/QtQmlModels/5.15.3"
        "${_qt5QmlModels_install_prefix}/include/aarch64-linux-gnu/qt5/QtQmlModels/5.15.3/QtQmlModels"
    )
    ...
    foreach(_module_dep ${_Qt5QmlModels_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5QmlModels_FIND_VERSION_EXACT}
    ...
    _populate_QmlModels_target_properties(RELEASE "libQt5QmlModels.so.5.15.3" "" FALSE)
    ...
    macro(_populate_QmlModels_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlModels_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlModels_check_file_exists(${imported_location})
