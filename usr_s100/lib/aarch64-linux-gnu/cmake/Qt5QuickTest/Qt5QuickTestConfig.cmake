...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5QuickTest" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickTest_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5QuickTest_VERSION_STRING 5.15.3)
...
macro(_populate_QuickTest_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QuickTest_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(_Qt5QuickTest_OWN_INCLUDE_DIRS "${_qt5QuickTest_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5QuickTest_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickTest")
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickTest/5.15.3"
        "${_qt5QuickTest_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickTest/5.15.3/QtQuickTest"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTest_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5QuickTest_FIND_VERSION_EXACT}
    ...
    _populate_QuickTest_target_properties(RELEASE "libQt5QuickTest.so.5.15.3" "" FALSE)
    ...
    macro(_populate_QuickTest_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickTest_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTest_check_file_exists(${imported_location})
