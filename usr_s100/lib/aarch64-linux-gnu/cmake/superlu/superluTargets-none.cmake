...
set_target_properties(superlu::superlu PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libsuperlu.so.5.3.0"
  IMPORTED_SONAME_NONE "libsuperlu.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS superlu::superlu )
list(APPEND _IMPORT_CHECK_FILES_FOR_superlu::superlu "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libsuperlu.so.5.3.0" )
