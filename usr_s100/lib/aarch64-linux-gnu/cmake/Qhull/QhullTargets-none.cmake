...
set_target_properties(Qhull::qhullcpp PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullcpp.so.8.0.2"
  IMPORTED_SONAME_NONE "libqhullcpp.so.8.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qhull::qhullcpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qhull::qhullcpp "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullcpp.so.8.0.2" )
...
set_target_properties(Qhull::qhull_r PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhull_r.so.8.0.2"
  IMPORTED_SONAME_NONE "libqhull_r.so.8.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qhull::qhull_r )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qhull::qhull_r "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhull_r.so.8.0.2" )
...
set_target_properties(Qhull::libqhull PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhull.so.8.0.2"
  IMPORTED_SONAME_NONE "libqhull.so.8.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qhull::libqhull )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qhull::libqhull "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhull.so.8.0.2" )
...
set_target_properties(Qhull::qhullcpp_static PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullcpp.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qhull::qhullcpp_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qhull::qhullcpp_static "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullcpp.a" )
...
set_target_properties(Qhull::qhullstatic PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullstatic.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qhull::qhullstatic )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qhull::qhullstatic "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullstatic.a" )
...
set_target_properties(Qhull::qhullstatic_r PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NONE "C"
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullstatic_r.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qhull::qhullstatic_r )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qhull::qhullstatic_r "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libqhullstatic_r.a" )
