...
set_target_properties(octomath PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomath.so.1.9.7"
  IMPORTED_SONAME_NONE "liboctomath.so.1.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomath )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomath "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomath.so.1.9.7" )
...
set_target_properties(octomath-static PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomath.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomath-static )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomath-static "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomath.a" )
...
set_target_properties(octomap PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomap.so.1.9.7"
  IMPORTED_SONAME_NONE "liboctomap.so.1.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomap )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomap "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomap.so.1.9.7" )
...
set_target_properties(octomap-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NONE "CXX"
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomap.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomap-static )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomap-static "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/liboctomap.a" )
