...
#define ARMA_AUX_LIBS /usr/lib/aarch64-linux-gnu/libblas.so;/usr/lib/aarch64-linux-gnu/liblapack.so;/usr/lib/aarch64-linux-gnu/libarpack.so;/usr/lib/aarch64-linux-gnu/libsuperlu.so
