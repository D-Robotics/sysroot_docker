...
set_target_properties(PySide2::pyside2 PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/aarch64-linux-gnu/libpyside2${PYTHON_CONFIG_SUFFIX}.so.5.15.2"
  IMPORTED_SONAME_RELWITHDEBINFO "libpyside2${PYTHON_CONFIG_SUFFIX}.so.5.15"
  )

list(APPEND _IMPORT_CHECK_TARGETS PySide2::pyside2 )
list(APPEND _IMPORT_CHECK_FILES_FOR_PySide2::pyside2 "${_IMPORT_PREFIX}/aarch64-linux-gnu/libpyside2${PYTHON_CONFIG_SUFFIX}.so.5.15.2" )
