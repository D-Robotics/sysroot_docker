...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5QuickShapes" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickShapes_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5QuickShapes_VERSION_STRING 5.15.3)
...
macro(_populate_QuickShapes_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QuickShapes_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(_Qt5QuickShapes_OWN_INCLUDE_DIRS "${_qt5QuickShapes_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5QuickShapes_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickShapes")
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickShapes/5.15.3"
        "${_qt5QuickShapes_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickShapes/5.15.3/QtQuickShapes"
    )
    ...
    foreach(_module_dep ${_Qt5QuickShapes_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5QuickShapes_FIND_VERSION_EXACT}
    ...
    _populate_QuickShapes_target_properties(RELEASE "libQt5QuickShapes.so.5.15.3" "" FALSE)
