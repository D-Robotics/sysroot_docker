...
macro(find_openni2)
  ...
  if(NOT OPENNI2_ROOT AND ("TRUE" STREQUAL "TRUE"))
    ...
    get_filename_component(OPENNI2_LIBRARY_HINT "/usr/lib/aarch64-linux-gnu/libOpenNI2.so" PATH)
  endif()
...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "/usr/lib/aarch64-linux-gnu/cmake/vtk-9.1" CACHE PATH "The directory containing VTKConfig.cmake")
  endif()
  if(NOT ANDROID)
...
if(EXISTS "${PCL_ROOT}/include/pcl-${PCL_VERSION_MAJOR}.${PCL_VERSION_MINOR}/pcl/pcl_config.h")
  ...
  set(PCL_LIBRARY_DIRS "${PCL_ROOT}/lib/aarch64-linux-gnu")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_LIBRARY_DIRS "${PCL_DIR}/lib/aarch64-linux-gnu")
else()
...
set(pcl_all_components  common kdtree octree search sample_consensus filters 2d geometry io features ml segmentation visualization surface registration keypoints tracking recognition stereo apps in_hand_scanner modeler point_cloud_editor outofcore people)
