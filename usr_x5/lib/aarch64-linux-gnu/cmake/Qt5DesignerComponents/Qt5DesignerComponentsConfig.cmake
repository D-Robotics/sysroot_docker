...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5DesignerComponents" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5DesignerComponents_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5DesignerComponents_VERSION_STRING 5.15.3)
...
macro(_populate_DesignerComponents_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5DesignerComponents_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    set(_Qt5DesignerComponents_OWN_INCLUDE_DIRS "${_qt5DesignerComponents_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5DesignerComponents_install_prefix}/include/aarch64-linux-gnu/qt5/QtDesignerComponents")
    set(Qt5DesignerComponents_PRIVATE_INCLUDE_DIRS
        "${_qt5DesignerComponents_install_prefix}/include/aarch64-linux-gnu/qt5/QtDesignerComponents/5.15.3"
        "${_qt5DesignerComponents_install_prefix}/include/aarch64-linux-gnu/qt5/QtDesignerComponents/5.15.3/QtDesignerComponents"
    )
    ...
    foreach(_module_dep ${_Qt5DesignerComponents_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5DesignerComponents_FIND_VERSION_EXACT}
    ...
    _populate_DesignerComponents_target_properties(RELEASE "libQt5DesignerComponents.so.5.15.3" "" FALSE)
