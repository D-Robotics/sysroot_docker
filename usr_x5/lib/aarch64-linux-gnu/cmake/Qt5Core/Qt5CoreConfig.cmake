...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/aarch64-linux-gnu/qt5/QtCore/5.15.3"
        "${_qt5Core_install_prefix}/include/aarch64-linux-gnu/qt5/QtCore/5.15.3/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;getentropy;glib;glibc;posix-libiconv;hijricalendar;icu;inotify;linkat;system-pcre2;poll_ppoll;renameat2;sha3-fast;statx;system-doubleconversion)
    set_property(TARGET Qt5::Core
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.15.3" "" FALSE)
