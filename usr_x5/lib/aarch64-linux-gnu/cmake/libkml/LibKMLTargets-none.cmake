...
set_target_properties(kmlbase PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NONE "/usr/lib/aarch64-linux-gnu/libexpat.so;/usr/lib/aarch64-linux-gnu/libz.so;/usr/lib/aarch64-linux-gnu/libminizip.so;/usr/lib/aarch64-linux-gnu/liburiparser.so;/usr/lib/aarch64-linux-gnu/libexpat.so"
  IMPORTED_LOCATION_NONE "/usr/lib/aarch64-linux-gnu/libkmlbase.so.1.3.0"
  IMPORTED_SONAME_NONE "libkmlbase.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlbase )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlbase "/usr/lib/aarch64-linux-gnu/libkmlbase.so.1.3.0" )
...
set_target_properties(kmldom PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "/usr/lib/aarch64-linux-gnu/libkmldom.so.1.3.0"
  IMPORTED_SONAME_NONE "libkmldom.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmldom )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmldom "/usr/lib/aarch64-linux-gnu/libkmldom.so.1.3.0" )
...
set_target_properties(kmlxsd PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NONE "kmlbase"
  IMPORTED_LOCATION_NONE "/usr/lib/aarch64-linux-gnu/libkmlxsd.so.1.3.0"
  IMPORTED_SONAME_NONE "libkmlxsd.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlxsd )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlxsd "/usr/lib/aarch64-linux-gnu/libkmlxsd.so.1.3.0" )
...
set_target_properties(kmlengine PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "/usr/lib/aarch64-linux-gnu/libkmlengine.so.1.3.0"
  IMPORTED_SONAME_NONE "libkmlengine.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlengine )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlengine "/usr/lib/aarch64-linux-gnu/libkmlengine.so.1.3.0" )
...
set_target_properties(kmlconvenience PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "/usr/lib/aarch64-linux-gnu/libkmlconvenience.so.1.3.0"
  IMPORTED_SONAME_NONE "libkmlconvenience.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlconvenience )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlconvenience "/usr/lib/aarch64-linux-gnu/libkmlconvenience.so.1.3.0" )
...
set_target_properties(kmlregionator PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "/usr/lib/aarch64-linux-gnu/libkmlregionator.so.1.3.0"
  IMPORTED_SONAME_NONE "libkmlregionator.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS kmlregionator )
list(APPEND _IMPORT_CHECK_FILES_FOR_kmlregionator "/usr/lib/aarch64-linux-gnu/libkmlregionator.so.1.3.0" )
