...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5QuickParticles" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickParticles_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5QuickParticles_VERSION_STRING 5.15.3)
...
macro(_populate_QuickParticles_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QuickParticles_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    set(_Qt5QuickParticles_OWN_INCLUDE_DIRS "${_qt5QuickParticles_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5QuickParticles_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickParticles")
    set(Qt5QuickParticles_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickParticles_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickParticles/5.15.3"
        "${_qt5QuickParticles_install_prefix}/include/aarch64-linux-gnu/qt5/QtQuickParticles/5.15.3/QtQuickParticles"
    )
    ...
    foreach(_module_dep ${_Qt5QuickParticles_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5QuickParticles_FIND_VERSION_EXACT}
    ...
    _populate_QuickParticles_target_properties(RELEASE "libQt5QuickParticles.so.5.15.3" "" FALSE)
