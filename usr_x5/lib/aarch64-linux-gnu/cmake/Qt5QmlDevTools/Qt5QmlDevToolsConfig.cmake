...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5QmlDevTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QmlDevTools_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5QmlDevTools_VERSION_STRING 5.15.3)
...
function(_qt5_QmlDevTools_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5QmlDevTools_install_prefix}/lib/aarch64-linux-gnu/")
...
macro(_populate_QmlDevTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QmlDevTools_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(_Qt5QmlDevTools_OWN_INCLUDE_DIRS "${_qt5QmlDevTools_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5QmlDevTools_install_prefix}/include/aarch64-linux-gnu/qt5/QtQml")
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/aarch64-linux-gnu/qt5/QtQml/5.15.3"
        "${_qt5QmlDevTools_install_prefix}/include/aarch64-linux-gnu/qt5/QtQml/5.15.3/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5QmlDevTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5QmlDevTools_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_QmlDevTools_process_prl_file(
            "${_qt5QmlDevTools_install_prefix}/lib/aarch64-linux-gnu/libQt5QmlDevTools.prl" RELEASE
