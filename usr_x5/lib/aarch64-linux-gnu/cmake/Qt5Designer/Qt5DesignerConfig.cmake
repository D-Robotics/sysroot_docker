...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5Designer" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Designer_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5Designer_VERSION_STRING 5.15.3)
...
macro(_populate_Designer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Designer_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Designer)
    ...
    set(_Qt5Designer_OWN_INCLUDE_DIRS "${_qt5Designer_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5Designer_install_prefix}/include/aarch64-linux-gnu/qt5/QtDesigner")
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/aarch64-linux-gnu/qt5/QtDesigner/5.15.3"
        "${_qt5Designer_install_prefix}/include/aarch64-linux-gnu/qt5/QtDesigner/5.15.3/QtDesigner"
    )
    ...
    foreach(_module_dep ${_Qt5Designer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Designer_FIND_VERSION_EXACT}
    ...
    _populate_Designer_target_properties(RELEASE "libQt5Designer.so.5.15.3" "" FALSE)
    ...
    macro(_populate_Designer_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Designer_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Designer_check_file_exists(${imported_location})
